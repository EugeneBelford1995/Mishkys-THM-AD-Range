...
New-ADUser -Name "Manage AD" -Description "Manage AD" -SamAccountName "Manage.AD" -UserPrincipalName "Manage.Ad@$ADRoot" -Path "ou=User_Accounts,$ADRoot" -AccountPassword $Password -PasswordNeverExpires $true -Enabled $true
...
New-Item "C:\Share\AdminStuff"  -ItemType Directory
...
$AccessRule = New-Object System.Security.AccessControl.FileSystemAccessRule("$ADName\Manage.AD","Read","ContainerInherit,ObjectInherit","None","Allow")
